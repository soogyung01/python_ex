# Q) 369 게임 만들기
# 1~99까지 1씩 증가 3, 6, 9가 들어 있을 때마다 숫자와 함께 '짝!'을 출력 
# 3 -> '짝!'
# 66 -> '짝!짝!'
# 99 -> '짝!짝!'
...
#  3대의 열차가 교차하는 시간을 구해 열차가 충돌 사고를 막으세요
...
# 팩토리얼(factorial, !) n!은 1부터 양의 정수 n까지의 모든 정수를 곱한 값
# (4!은 1*2*3*4=24이다)
...
#     result *= num
# print(f'{userInputIntegerData}의 팩토리얼은 {result}')   

# Q) 숫자 맞추기 게임을 만들자
# 0부터 100사이의 난수를 발생시키고 사용자가 난수를 맞힐 때까지 계속해서 물어보는 게임
# --- 요구사항 ---
...
while guess != secretNumber: 
    ...
    if count < 10: 
        ...
        guess = int(input('틀렸습니다. 다시 입력하세요.'))
...
# Q) 가로 세로 길이의 변화에 따른 사각형의 넓이를 구하기
