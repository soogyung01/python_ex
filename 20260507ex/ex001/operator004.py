...
# # and(&) 연산자 
# # and는 '그리고'라는 뜻으로,
# # 피연산자가 모두 True인 경우에만 결과가 True 입니다.
# # 피연산자가 하나라도 False이면 결과는 False 입니다.
# var1 = True
# var2 = True
...
# # or(|) 연산자 (| -> 비트or연산자_2진수로 계산하여 10진수로 변환)
# # or는 '또는'라는 뜻으로,
# # 피연산자 중 하나라도 True라면 결과값은 True가 됩니다.
# var1 = True
# var2 = True
...
# result = (num1 < num2) and (num2 < num3) & (num3 > num1)
# print(f'result: {result}')                #True
...
# Q) 어린이용 범퍼카 탑승 가능 판별하기
# 사용 기준을 '신장이 120cm 이상이고 170cm 미만인 어린이'
# (탑승 가능은 True, 탑승 불가능은 False를 출력합니다.)
...
# Q) 적자/흑자 판단하기
# DW 마트는 수입과 지출을 입력하면 적자인지 흑자인지 판별하는 프로그램을 도입하려고 합니다. 
